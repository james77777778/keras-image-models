...
class EfficientNetLite(FeatureExtractor):
    def __init__(
        self,
        width: float = 1.0,
        depth: float = 1.0,
            ...
            for current_layer_idx in range(r):
                ...
                if block_type == "ds":
                    x = apply_depthwise_separation_block(
                        x, c, k, 1, s, "relu6", **common_kwargs
                    )
                elif block_type == "ir":
                    x = apply_inverted_residual_block(
                        x, c, k, 1, 1, s, e, "relu6", **common_kwargs
                    )
                elif block_type == "cn":
                    x = apply_conv2d_block(
                        x,
...
class EfficientNetLiteB0(EfficientNetLite):
    def __init__(
        self,
        input_tensor: keras.KerasTensor = None,
        input_shape: typing.Optional[typing.Sequence[int]] = None,
...
class EfficientNetLiteB1(EfficientNetLite):
    def __init__(
        self,
        input_tensor: keras.KerasTensor = None,
        input_shape: typing.Optional[typing.Sequence[int]] = None,
...
class EfficientNetLiteB2(EfficientNetLite):
    def __init__(
        self,
        input_tensor: keras.KerasTensor = None,
        input_shape: typing.Optional[typing.Sequence[int]] = None,
...
class EfficientNetLiteB3(EfficientNetLite):
    def __init__(
        self,
        input_tensor: keras.KerasTensor = None,
        input_shape: typing.Optional[typing.Sequence[int]] = None,
...
class EfficientNetLiteB4(EfficientNetLite):
    def __init__(
        self,
        input_tensor: keras.KerasTensor = None,
        input_shape: typing.Optional[typing.Sequence[int]] = None,
