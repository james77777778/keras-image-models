...
from kimm.models import efficientnet_lite
...
keras_model_classes = [
    efficientnet_lite.EfficientNetLiteB0,
    efficientnet_lite.EfficientNetLiteB1,
    efficientnet_lite.EfficientNetLiteB2,
    efficientnet_lite.EfficientNetLiteB3,
    efficientnet_lite.EfficientNetLiteB4,
]
